          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-6">
                <div>
                  <label htmlFor="professionalSummary" className="block text-sm font-medium text-slate-700 mb-2">
                ...
                <div>
                  <label htmlFor="workExperience" className="block text-sm font-medium text-slate-700 mb-2">
                    Work Experience *
                  </label>
                  <textarea
                    id="workExperience"
